...
- [x] Expanded Power Infrastructure — Session 8 (post-crash), 8:50
- [x] Hypertubes — Session 8 (post-crash), 49:00
...
## Coal Power Expansion (Session 8)
...
## Steel Iron Mine — Post Upgrade (Session 8)

| Component | Detail | Draw |
|-----------|--------|------|
| 2x Mk.2 Miner (150% each) | 360/min Iron | 51.2 MW |
| Truck Stop | — | 20 MW |
| **Total** | **360/min Iron** | **71.2 MW** |
...
- Steel Iron Mine originally built on 2 Normal Iron nodes, 150/min by tractor — upgraded to 2x Mk.2 at 150% each, 360/min (Session 8)
- Steel Factory on 2 Pure Coal nodes — Unit A (Steel Pipe 20/min) unchanged; Unit B revamped to produce Steel Beam, Encased Industrial Beam, and Versatile Framework (Session 8)
